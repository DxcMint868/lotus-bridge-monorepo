...
const AdvancedOptions: React.FC<AdvancedOptionsProps> = ({ isOpen, onToggle }) => {
  ...
  return (
    <Collapsible open={isOpen} onOpenChange={onToggle}>
      <CollapsibleTrigger asChild>
        <Button
          variant="ghost"
          className="w-full justify-between text-lotus-pink hover:text-lotus-pink-dark hover:bg-pink-50"
        >
      ...
      <CollapsibleContent className="mt-4">
        <Card className="bg-gradient-to-r from-pink-50/50 to-green-50/50 border-pink-200">
          <CardContent className="pt-6 space-y-6">
              ...
              <div className="flex space-x-2">
                {slippagePresets.map((preset) => (
                  <Button
                    ...
                    className={slippage === preset ? "lotus-gradient text-white" : "border-pink-200 hover:bg-pink-50"}
                  >
                    {preset}%
                  </Button>
                ))}
            ...
            <div className="space-y-3">
              <Label className="text-base font-medium">Transaction Deadline</Label>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <Label className="text-base font-medium">Bridge Gas Token</Label>
                <p className="text-sm text-gray-600">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <Label className="text-base font-medium">Custom Recipient</Label>
                <p className="text-sm text-gray-600">
