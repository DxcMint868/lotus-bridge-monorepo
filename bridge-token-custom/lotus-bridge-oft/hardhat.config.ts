...
const etherscanKey: string = process.env.ETHERSCAN_KEY
  ...
  : "";
const basescanKey: string = process.env.BASESCAN_KEY
  ? (process.env.BASESCAN_KEY as string)
  : "";
const bscscanKey: string = process.env.BSCSCAN_KEY
  ? (process.env.BSCSCAN_KEY as string)
  : "";
...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    base_sepolia: {
      url: `https://base-sepolia.infura.io/v3/${infuraKey}`,
      chainId: 84532,
      accounts: [`0x${privateKey}`],
    },
    base_mainnet: {
