...
export const AlternativeLogo = ({ className }: AlternativeLogoProps) => {
  return (
    <div
      className={`w-10 h-10 rounded-full lotus-gradient border-1 border-white flex items-center justify-center ${className}`}
    >
      <svg
        ...
        className="lucide lucide-flower w-85% h-85% text-white"
      >
